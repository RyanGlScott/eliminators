...
elimSo :: forall {m} (p :: forall (long_sucker :: Bool). So long_sucker -> @m Type)
                 (what :: Bool) (s :: So what).
          Sing s
       -> p Oh
       -> p s
...
elimPropSo :: forall {m} (p :: Bool -> @m Prop) (what :: Bool).
              So what
           -> p True
           -> p what
...
elimFlarble :: forall {m} (p :: forall x y. Flarble x y -> @m Type)
                      a b (f :: Flarble a b).
               Sing f
...
elimPropFlarble :: forall {m} {n} (p :: Type -> @m Type -> @n Prop) a b.
                   Flarble a b
                -> (forall a' b'. a' -> p a' b')
...
elimObj :: forall {m} (p :: Obj -> @m Type) (o :: Obj).
           Sing o
